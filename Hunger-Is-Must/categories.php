...
<div id="cart-content" class="cart-content">
    ...
    <!-- Category Section Start -->
     <!-- we have used ?search= food item to get dynamic behaviour in search section -->
    <section class="categories">
        <div class="container">
            ...
            <div class="grid-3">
                <a href="category-foods.php?search=Pizza">
                    <div class="float-container">
                        <img src="img/category/pizza.jpg" class="img-responsive" alt="">
                        <h3 class="float-text text-white">Pizza</h3>
                    </div>
                </a>
                <a href="category-foods.php?search=sandwich">
                    <div class="float-container">
                        <img src="img/category/sandwich.jpg" class="img-responsive" alt="">
                        <h3 class="float-text text-white">Sandwich</h3>
                    </div>
                </a>
                <a href="category-foods.php?search=burger">
                    <div class="float-container">
                        <img src="img/category/burger.jpg" class="img-responsive" alt="">
                        <h3 class="float-text text-white">Burger</h3>
                    </div>
                </a>
                <a href="category-foods.php?search=Fries">
                    <div class="float-container">
                        <img src="img/category/fries.jpg" class="img-responsive" alt="">
                        <h3 class="float-text text-white">Fries</h3>
                    </div>
                </a>
                <a href="category-foods.php?search=Momos">
                    <div class="float-container">
                        <img src="img/category/momo.jpg" class="img-responsive" alt="">
                        <h3 class="float-text text-white">Momos</h3>
                    </div>
                </a>
                <a href="category-foods.php?search=Pasta">
                    <div class="float-container">
                        <img src="img/category/pasta.jpg" class="img-responsive" alt="">
